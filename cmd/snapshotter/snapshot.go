// Copied from https://raw.githubusercontent.com/containerd/stargz-snapshotter/main/snapshot/snapshot.go
/*
...
func NewSnapshotter(ctx context.Context, root string, targetFs FileSystem, opts ...Opt) (*snapshotter, error) {
	if targetFs == nil {
...
func (o *snapshotter) Stat(ctx context.Context, key string) (snapshots.Info, error) {
	log.G(ctx).WithFields(logrus.Fields{
		"key": key,
	}).Debugf("snapshotter Stat() called")
...
func (o *snapshotter) Update(ctx context.Context, info snapshots.Info, fieldpaths ...string) (snapshots.Info, error) {
	log.G(ctx).Info("snapshotter Update() called")
...
func (o *snapshotter) Usage(ctx context.Context, key string) (snapshots.Usage, error) {
	log.G(ctx).Info("snapshotter Usage() called")
	ctx, t, err := o.ms.TransactionContext(ctx, false)
	if err != nil {
...
func (o *snapshotter) Prepare(ctx context.Context, key, parent string, opts ...snapshots.Opt) ([]mount.Mount, error) {
	log.G(ctx).WithFields(logrus.Fields{
		...
		"parent": parent,
		"opts":   opts,
	}).Info("snapshotter Prepare() called")
	...
	if target, ok := base.Labels[sns.SnapshotLabelRefUncompressed]; ok {
		...
		//	return nil, err
		//}
		log.G(ctx).WithField("target", target).Info("prepare remote layer")
		if err := o.prepareRemoteSnapshot(ctx, key, base.Labels); err != nil {
			log.G(ctx).WithError(err).Error("failed to prepare remote layer")
			return nil, err
		}
	}
	mnt, err := o.mounts(ctx, s, parent)
	if err != nil {
		return nil, err
	}
	log.G(ctx).WithField("mnt", mnt).Debugf("prepare done")
	return mnt, nil
}

func (o *snapshotter) View(ctx context.Context, key, parent string, opts ...snapshots.Opt) ([]mount.Mount, error) {
	log.G(ctx).Info("snapshotter View() called")
...
func (o *snapshotter) Mounts(ctx context.Context, key string) ([]mount.Mount, error) {
	log.G(ctx).Info("snapshotter Mount() called")
	ctx, t, err := o.ms.TransactionContext(ctx, false)
	if err != nil {
		return nil, err
	}
...
func (o *snapshotter) Commit(ctx context.Context, name, key string, opts ...snapshots.Opt) error {
	log.G(ctx).Info("snapshotter Commit() called")
...
func (o *snapshotter) Remove(ctx context.Context, key string) (err error) {
	log.G(ctx).Info("snapshotter Remove() called")
	ctx, t, err := o.ms.TransactionContext(ctx, true)
	if err != nil {
		return err
	}
...
func (o *snapshotter) Cleanup(ctx context.Context) error {
	log.G(ctx).Info("snapshotter Cleanup() called")
	const cleanupCommitted = false
...
func (o *snapshotter) Close() error {
	log.G(context.TODO()).Info("snapshotter Close() called")
